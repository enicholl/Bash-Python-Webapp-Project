# import sys module to insert variables from index.js file
import sys

# function returns total number of dogs
def dog(player_number=100):
    ...
    print(Dog)  # prints the total number added to the Dog variable

#  runs the function dog()
dog()
