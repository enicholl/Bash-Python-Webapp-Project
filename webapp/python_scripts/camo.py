# imports sys module used to insert variables from index.js file
import sys


# code for returning the total number of cat and mouse
def camo(player_number=100):
    ...
    print(Cat_Mouse)  # prints total number added to the Cat_Mouse variable

# runs the function camo()
camo()
