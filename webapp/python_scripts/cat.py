# imports sys module to insert variables from the index.js file
import sys


# code for returning the total number of cats
def cat(player_number=100):
    ...
    print(Cat)  # prints the total number of cats added to variable Cat

#  runs the function cat()
cat()
